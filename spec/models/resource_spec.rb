...
describe Resource do
  ...
  it "should require a link" do
	...
	describe "twitter import" do
		...
		it "should skip urls that don't resolve" do
			
		end
		
		it "should skip tweets without links" do
		
		end
		
		it "should skip tweets without #resource" do
			
		end
		
		it "should approve resources with registered users" do
