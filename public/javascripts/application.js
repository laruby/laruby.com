...
$(document).ready(function() {
	$.Juitter.start({
		...
		searchObject:"laruby", // needed, you can insert a username here or a word to be searched for, if you wish multiple search, separate the words by comma.
		...
		placeHolder:"larubyTweets", // Set a place holder DIV which will receive the list of tweets example <div id="juitterContainer"></div>
